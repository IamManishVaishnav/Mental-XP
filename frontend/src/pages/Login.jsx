    ...
    <div className="min-h-screen bg-surface dark:bg-dark flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display font-bold text-3xl text-textPrimary dark:text-white">Welcome back</h1>
          <p className="text-textSecondary mt-2">Sign in to continue your journey</p>
        </div>
