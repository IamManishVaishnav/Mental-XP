  ...
  return (
    <div className="min-h-screen bg-[var(--cream)] flex items-center justify-center px-4">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden opacity-40">
        <div className="absolute top-20 left-20 w-64 h-64 rounded-full bg-forest-100 dark:bg-forest-900/20 blur-3xl" />
        <div className="absolute bottom-20 right-20 w-80 h-80 rounded-full bg-amber-100 dark:bg-amber-900/10 blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-sm relative animate-fade-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-ink-muted text-sm mt-1.5">Sign in to continue your journey</p>
        </div>
        ...
        <p className="text-center text-ink-muted text-sm mt-5">
          ...
          <Link to="/signup" className="text-forest-600 dark:text-forest-400 font-semibold hover:underline">
            Create one
          </Link>
        </p>
      </div>
